...
![Data Logging](data-logging.png "https://www.motadata.com/blog/what-is-data-logging/")
...
[나는 생각한다, Go로 나는 분산 로깅을 개발한다](https://devocean.sk.com/blog/techBoardDetail.do?ID=165547&boardType=techBlog&searchData=&id=&vcode=&vcodeList=)  
...
[다나와 웹 트래픽 로그 데이터 분석 시스템 도입기](https://danawalab.github.io/danawaservice/2023/12/13/Danawa-Logging-Analytics-Service.html)  
[Telegraf vs Fluentd vs Fluent Bit](https://velog.io/@thouy/Telegraf-vs-Fluentd-vs-Fluent-Bit)  
[Fluentd vs Telegraf 차이점 알아보기](https://blog.voidmainvoid.net/260)

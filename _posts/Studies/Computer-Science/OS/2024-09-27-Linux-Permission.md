...
tags:
  ...
  - Command
  - Permission
description: Linux 권한 설정
comments: "true"
toc: "true"
media_subpath: /assets/img/
---

![Linux Permissions](linux-permissions.jpg "https://medium.com/@usamashafique00786/day-4-task-linux-permissions-and-access-control-lists-ef59cebf9324")
...
- Permissions : 각 파일에 접근해서 읽거나 쓰거나 실행할 권리를 갖는 소유자 / 그룹 / 다른 사용자로 나눠서 관리
  ![Linux Permission](Files-permissions-and-ownership-basics-in-Linux.png "https://pamirwebhost.com/check-linux-file-permissions-with-ls/")
  ...
  - Permission\
    ![Linux File permissions](linux-file-permissions.jpg "https://medium.com/@gumbershruti1119/day-6-file-permissions-and-access-control-lists-2126f994a5b8")
